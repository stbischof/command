 ...
 */
package org.eclipse.osgi.technology.command.osgi.service.servlet;
...
public class Activator extends AbstractActivator {
    ...
    @Override
    protected void init() {
        registerCommandService(new ServletWhiteboardCommand(context, formatter), "tech", Map.of());
        registerConverterService(new ServletWhiteboardConverter(formatter));
    }

    private static class ServletWhiteboardConverter extends BaseDTOFormatterConverter {

        public ServletWhiteboardConverter(DTOFormatter formatter) {
            super(formatter);
        }
    }
}
